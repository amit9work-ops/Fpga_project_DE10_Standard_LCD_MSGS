...
\node[loop] (poll) at (0, -1.6)
  {\shortstack{Read \texttt{fsm\_status\_pio} and \texttt{timer\_status\_pio};\\
   read message text via seqlock (retry if torn)}};
...
\node[renderupd] (upd) at (2.75, -8.55)
  {Assemble 4\,$\times$\,16 chars from the bridge words \& render to LCD};
