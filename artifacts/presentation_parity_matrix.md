...
| C-005 | Debounce and timer behavior are verified pre-board | Satisfied | hw/sim/testbenches/tb_button_debouncer.v, hw/sim/testbenches/tb_idle_timer.v | None | Keep tests mandatory | Verification | Canonical regression pass |
| C-006 | End-to-end button-to-LCD latency meets presentation target | In Progress | scripts/hardware/latency_summary.ps1 | Hardware-measurement | Capture board latency CSV artifacts and compute summary against target | Verification | Measured latency <= target |
...
| C-008 | Final demo flow is reproducible | In Progress | README.md, scripts/hardware/generate_signoff_report.ps1, verify_all.ps1, sim/run_all_sim.ps1, artifacts/hardware/demo_checklist_log.md, artifacts/hardware/signoff_report.md | Doc/Test | Execute board runbook once and record pass/fail checklist artifacts | Project | Dry-run completed end-to-end |
